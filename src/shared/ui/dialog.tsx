...
interface DialogContentProps
  ...
  /** Renders overlay + panel above Sheets (z-[9999]) — confirms inside sheets. */
  stacked?: boolean;
}
...
>(({ className, children, stacked = false, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none rtl:left-4 rtl:right-auto">
        <X className="h-4 w-4" />
