...
3. Append to `.audit/findings/deferred-{{GROUP}}.md` one row per item: `| shard-0NN-FNN | applied | what changed, file:line |` or `| … | skipped | ruling R-N / reason |`, ending with a line exactly `APPLIED: <n> SKIPPED: <m>`.
