# UI coherence audit — shard shard-005 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-005.md` with this structure:
...
## Findings
### shard-005-F01 · <severity> · <confidence> · <dimension>
