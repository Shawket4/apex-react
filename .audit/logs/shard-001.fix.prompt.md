# UI coherence fix — shard shard-001
...
3. `.audit/findings/shard-001.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-001.fix.md`, even when nothing was applied:

```
# Fix log — shard-001
| Finding | Status | Detail |
|---|---|---|
| shard-001-F01 | applied | `old-class` → `new-class` in file:line |
| shard-001-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/shared/api/client.ts` (201 lines)
- `src/shared/api/errors.ts` (75 lines)
- `src/shared/api/query.ts` (19 lines)
- `src/shared/auth/store.ts` (83 lines)
- `src/shared/config/constants.ts` (68 lines)
- `src/shared/config/env.ts` (17 lines)
- `src/shared/hooks/use-debounce.ts` (12 lines)
- `src/shared/hooks/use-etit-live.ts` (146 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/hooks/use-layout-store.ts` (13 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/hooks/use-media-query.ts` (21 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/hooks/use-mounted.ts` (7 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/hooks/use-permissions.ts` (27 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/i18n/index.ts` (46 lines)
- `src/shared/lib/animations.ts` (38 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/lib/cairo.ts` (201 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/lib/chart-theme.ts` (84 lines)
- `src/shared/lib/cn.ts` (6 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/lib/coords.ts` (72 lines)
- `src/shared/lib/excel.ts` (356 lines)
- `src/shared/lib/format-number.ts` (44 lines)
- `src/shared/lib/format.ts` (128 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/lib/fuel.ts` (359 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/lib/money.ts` (135 lines)
- `src/shared/lib/normalize.ts` (239 lines)
- `src/shared/lib/polyline.ts` (47 lines)
- `src/shared/lib/zod-utils.ts` (24 lines)
