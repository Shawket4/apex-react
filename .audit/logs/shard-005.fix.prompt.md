# UI coherence fix — shard shard-005
...
3. `.audit/findings/shard-005.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-005.fix.md`, even when nothing was applied:

```
# Fix log — shard-005
| Finding | Status | Detail |
|---|---|---|
| shard-005-F01 | applied | `old-class` → `new-class` in file:line |
| shard-005-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/app/router/index.tsx` (333 lines)
- `src/app/router/protected-route.tsx` (26 lines)
- `src/entities/auth/api.ts` (11 lines)
- `src/entities/auth/queries.ts` (59 lines)
- `src/entities/auth/schemas.ts` (16 lines)
- `src/pages/auth/login.tsx` (177 lines)
- `src/entities/car/api.ts` (49 lines)
- `src/entities/car/queries.ts` (55 lines)
- `src/entities/car/schemas.ts` (81 lines)
- `src/widgets/car-form/car-form.tsx` (329 lines)
- `src/pages/cars/cars.tsx` (117 lines)
- `src/widgets/cars-table/cars-table.tsx` (265 lines)
- `src/widgets/command-palette/command-palette.tsx` (564 lines)  — **REFERENCE: do not audit, do not edit**
