# UI coherence audit — shard shard-020 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-020.md` with this structure:
...
## Findings
### shard-020-F01 · <severity> · <confidence> · <dimension>
