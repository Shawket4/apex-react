# UI coherence fix — shard shard-007
...
3. `.audit/findings/shard-007.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-007.fix.md`, even when nothing was applied:

```
# Fix log — shard-007
| Finding | Status | Detail |
|---|---|---|
| shard-007-F01 | applied | `old-class` → `new-class` in file:line |
| shard-007-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/widgets/driver-detail/documents-tab.tsx` (453 lines)
- `src/widgets/driver-detail/financial-tab.tsx` (95 lines)
- `src/widgets/driver-detail/overview-tab.tsx` (305 lines)
- `src/widgets/driver-detail/pin-tab.tsx` (152 lines)
- `src/entities/driver-expense/api.ts` (23 lines)
- `src/entities/driver-expense/queries.ts` (65 lines)
- `src/entities/driver-expense/schemas.ts` (84 lines)
- `src/pages/driver-expenses/driver-expense-new.tsx` (250 lines)
- `src/pages/driver-expenses/driver-expenses.tsx` (302 lines)
- `src/widgets/driver-form/driver-form.tsx` (221 lines)
- `src/entities/driver-loan/api.ts` (23 lines)
- `src/entities/driver-loan/queries.ts` (65 lines)
- `src/entities/driver-loan/schemas.ts` (54 lines)
