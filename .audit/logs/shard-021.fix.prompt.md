# UI coherence fix — shard shard-021
...
3. `.audit/findings/shard-021.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-021.fix.md`, even when nothing was applied:

```
# Fix log — shard-021
| Finding | Status | Detail |
|---|---|---|
| shard-021-F01 | applied | `old-class` → `new-class` in file:line |
| shard-021-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/widgets/trip-audit-detail-dialog/index.ts` (1 lines)
- `src/widgets/trip-audit-detail-dialog/trip-audit-detail-dialog.tsx` (1275 lines)
- `src/widgets/trip-audit-matches-table/audit-format.tsx` (56 lines)
- `src/widgets/trip-audit-matches-table/index.ts` (6 lines)
- `src/widgets/trip-audit-queue/index.ts` (1 lines)
- `src/widgets/trip-audit-queue/trip-audit-queue.tsx` (260 lines)
