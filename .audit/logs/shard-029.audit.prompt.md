# UI coherence audit — shard shard-029 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-029.md` with this structure:
...
## Findings
### shard-029-F01 · <severity> · <confidence> · <dimension>
