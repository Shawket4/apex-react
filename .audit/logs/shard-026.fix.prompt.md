# UI coherence fix — shard shard-026
...
3. `.audit/findings/shard-026.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-026.fix.md`, even when nothing was applied:

```
# Fix log — shard-026
| Finding | Status | Detail |
|---|---|---|
| shard-026-F01 | applied | `old-class` → `new-class` in file:line |
| shard-026-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/pages/trips/trip-edit.tsx` (51 lines)
- `src/pages/trips/trip-new.tsx` (27 lines)
- `src/pages/trips/trips.tsx` (606 lines)
- `src/widgets/trips-statistics/trips-statistics-car-table.tsx` (216 lines)
- `src/widgets/trips-statistics/trips-statistics-cars.tsx` (153 lines)
- `src/widgets/trips-statistics/trips-statistics-companies.tsx` (1118 lines)
