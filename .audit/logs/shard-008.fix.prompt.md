# UI coherence fix — shard shard-008
...
3. `.audit/findings/shard-008.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-008.fix.md`, even when nothing was applied:

```
# Fix log — shard-008
| Finding | Status | Detail |
|---|---|---|
| shard-008-F01 | applied | `old-class` → `new-class` in file:line |
| shard-008-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/pages/driver-loans/driver-loan-new.tsx` (212 lines)
- `src/pages/driver-loans/driver-loans.tsx` (410 lines)
- `src/pages/drivers/drivers.tsx` (60 lines)
- `src/widgets/drivers-table/drivers-table.tsx` (188 lines)
- `src/pages/error/not-found.tsx` (31 lines)
- `src/pages/error/route-error.tsx` (100 lines)
- `src/entities/fee-mapping/api.ts` (83 lines)
- `src/entities/fee-mapping/queries.ts` (159 lines)
- `src/entities/fee-mapping/schemas.ts` (137 lines)
- `src/pages/fee-mappings/fee-mappings.tsx` (252 lines)
