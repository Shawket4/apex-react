# UI coherence audit — shard shard-016 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-016.md` with this structure:
...
## Findings
### shard-016-F01 · <severity> · <confidence> · <dimension>
