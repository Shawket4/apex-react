# UI coherence fix — shard shard-015
...
3. `.audit/findings/shard-015.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-015.fix.md`, even when nothing was applied:

```
# Fix log — shard-015
| Finding | Status | Detail |
|---|---|---|
| shard-015-F01 | applied | `old-class` → `new-class` in file:line |
| shard-015-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/pages/oil-changes/oil-change-edit.tsx` (120 lines)
- `src/pages/oil-changes/oil-change-history.tsx` (409 lines)
- `src/pages/oil-changes/oil-change-new.tsx` (67 lines)
- `src/pages/oil-changes/oil-changes.tsx` (319 lines)
- `src/widgets/oil-changes-table/oil-change-status-badge.tsx` (56 lines)
- `src/widgets/oil-changes-table/oil-changes-excel.ts` (205 lines)
- `src/widgets/oil-changes-table/oil-changes-filters.tsx` (128 lines)
- `src/widgets/oil-changes-table/oil-changes-table.tsx` (255 lines)
- `src/pages/placeholder/placeholder.tsx` (46 lines)
- `src/entities/raw-message/api.ts` (32 lines)
- `src/entities/raw-message/queries.ts` (49 lines)
- `src/entities/raw-message/schemas.ts` (61 lines)
- `src/entities/receipt/api.ts` (32 lines)
- `src/entities/receipt/queries.ts` (80 lines)
- `src/entities/receipt/schemas.ts` (49 lines)
- `src/entities/receipt-batch/api.ts` (32 lines)
- `src/entities/receipt-batch/queries.ts` (59 lines)
- `src/entities/receipt-batch/schemas.ts` (27 lines)
- `src/widgets/scope-bar/scope-bar.tsx` (119 lines)  — **REFERENCE: do not audit, do not edit**
- `src/widgets/scope-bar/scope-date-picker.tsx` (188 lines)  — **REFERENCE: do not audit, do not edit**
- `src/widgets/service-cars-table/service-cars-table.tsx` (86 lines)
