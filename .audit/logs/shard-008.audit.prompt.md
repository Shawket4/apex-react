# UI coherence audit — shard shard-008 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-008.md` with this structure:
...
## Findings
### shard-008-F01 · <severity> · <confidence> · <dimension>
