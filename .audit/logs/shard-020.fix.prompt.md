# UI coherence fix — shard shard-020
...
3. `.audit/findings/shard-020.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-020.fix.md`, even when nothing was applied:

```
# Fix log — shard-020
| Finding | Status | Detail |
|---|---|---|
| shard-020-F01 | applied | `old-class` → `new-class` in file:line |
| shard-020-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/entities/trip-audit/api.ts` (136 lines)
- `src/entities/trip-audit/defaults.ts` (49 lines)
- `src/entities/trip-audit/index.ts` (3 lines)
- `src/entities/trip-audit/queries.ts` (176 lines)
- `src/entities/trip-audit/schemas.ts` (369 lines)
- `src/pages/trip-audit/trip-audit.tsx` (532 lines)
