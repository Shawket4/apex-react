# UI coherence fix — shard shard-016
...
3. `.audit/findings/shard-016.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-016.fix.md`, even when nothing was applied:

```
# Fix log — shard-016
| Finding | Status | Detail |
|---|---|---|
| shard-016-F01 | applied | `old-class` → `new-class` in file:line |
| shard-016-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/entities/service-invoice/api.ts` (54 lines)
- `src/entities/service-invoice/queries.ts` (96 lines)
- `src/entities/service-invoice/schemas.ts` (100 lines)
- `src/widgets/service-invoice-details/service-invoice-details.tsx` (326 lines)
- `src/widgets/service-invoice-form/service-invoice-form.tsx` (385 lines)
- `src/pages/service-invoices/service-invoice-details.tsx` (35 lines)
- `src/pages/service-invoices/service-invoice-edit.tsx` (52 lines)
- `src/pages/service-invoices/service-invoice-new.tsx` (36 lines)
- `src/pages/service-invoices/service-invoices.tsx` (225 lines)
- `src/widgets/service-invoices-table/service-invoices-table.tsx` (150 lines)
- `src/pages/settings/settings.tsx` (114 lines)
- `src/widgets/sidebar/sidebar.tsx` (290 lines)  — **REFERENCE: do not audit, do not edit**
- `src/widgets/terminal-select/index.ts` (1 lines)
- `src/widgets/terminal-select/terminal-select.tsx` (163 lines)
- `src/widgets/theme-toggle/theme-toggle.tsx` (49 lines)  — **REFERENCE: do not audit, do not edit**
- `src/pages/tires/tires.tsx` (254 lines)
