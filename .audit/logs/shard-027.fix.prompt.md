# UI coherence fix — shard shard-027
...
3. `.audit/findings/shard-027.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-027.fix.md`, even when nothing was applied:

```
# Fix log — shard-027
| Finding | Status | Detail |
|---|---|---|
| shard-027-F01 | applied | `old-class` → `new-class` in file:line |
| shard-027-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/widgets/trips-statistics/trips-statistics-excel.ts` (600 lines)
- `src/widgets/trips-statistics/trips-statistics-routes.tsx` (304 lines)
- `src/widgets/trips-statistics/trips-statistics-summary.tsx` (252 lines)
- `src/widgets/trips-statistics/trips-statistics-timeline.tsx` (451 lines)
- `src/widgets/trips-statistics/trips-statistics.tsx` (229 lines)
