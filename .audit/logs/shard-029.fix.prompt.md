# UI coherence fix — shard shard-029
...
3. `.audit/findings/shard-029.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-029.fix.md`, even when nothing was applied:

```
# Fix log — shard-029
| Finding | Status | Detail |
|---|---|---|
| shard-029-F01 | applied | `old-class` → `new-class` in file:line |
| shard-029-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/pages/users/users.tsx` (148 lines)
- `src/widgets/users-table/users-table.tsx` (261 lines)
- `src/entities/whatsapp/api.ts` (23 lines)
- `src/entities/whatsapp/queries.ts` (52 lines)
- `src/entities/whatsapp/schemas.ts` (9 lines)
- `src/widgets/whatsapp-gateway-card/index.ts` (1 lines)
- `src/widgets/whatsapp-gateway-card/whatsapp-gateway-card.tsx` (143 lines)
- `src/entities/zone/api.ts` (55 lines)
- `src/entities/zone/index.ts` (3 lines)
- `src/entities/zone/queries.ts` (114 lines)
- `src/entities/zone/schemas.ts` (40 lines)
- `src/widgets/zone-form-dialog/index.ts` (1 lines)
- `src/widgets/zone-form-dialog/zone-form-dialog.tsx` (228 lines)
- `src/widgets/zone-map-picker/index.ts` (1 lines)
- `src/widgets/zone-map-picker/zone-map-picker.tsx` (95 lines)
- `src/pages/zones/zones.tsx` (113 lines)
- `src/widgets/zones-table/columns.tsx` (116 lines)
- `src/widgets/zones-table/index.ts` (1 lines)
- `src/widgets/zones-table/zones-table.tsx` (35 lines)
