...
3. Append to `.audit/findings/repairs-shared.md` a table row per item: `| R01 | applied | what changed, file:line |` or `| R01 | skipped | why |`, ending with a line exactly `APPLIED: <n> SKIPPED: <m>`.

Print that last line as your final output.

## Your files
- `src/features/tracking/components/time-deck.tsx` (R05)
- `src/shared/i18n/locales/ar.json` (R19)
- `src/shared/lib/zod-utils.ts` (R07)
- `src/shared/ui/collapsible-section.tsx` (R02)
- `src/shared/ui/data-table.tsx` (R01)
- `src/shared/ui/stat-card.tsx` (R21)
