# UI coherence audit — shard shard-026 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-026.md` with this structure:
...
## Findings
### shard-026-F01 · <severity> · <confidence> · <dimension>
