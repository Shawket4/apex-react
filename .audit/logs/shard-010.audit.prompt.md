# UI coherence audit — shard shard-010 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-010.md` with this structure:
...
## Findings
### shard-010-F01 · <severity> · <confidence> · <dimension>
