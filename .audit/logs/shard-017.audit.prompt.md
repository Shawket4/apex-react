# UI coherence audit — shard shard-017 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-017.md` with this structure:
...
## Findings
### shard-017-F01 · <severity> · <confidence> · <dimension>
