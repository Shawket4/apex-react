# UI coherence fix — shard shard-004
...
3. `.audit/findings/shard-004.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-004.fix.md`, even when nothing was applied:

```
# Fix log — shard-004
| Finding | Status | Detail |
|---|---|---|
| shard-004-F01 | applied | `old-class` → `new-class` in file:line |
| shard-004-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/shared/ui/map-view.tsx` (205 lines)
- `src/shared/ui/month-year-selector.tsx` (127 lines)
- `src/shared/ui/multi-select.tsx` (262 lines)
- `src/shared/ui/native-select.tsx` (36 lines)
- `src/shared/ui/page-shell.tsx` (42 lines)
- `src/shared/ui/popover.tsx` (31 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/progress.tsx` (22 lines)
- `src/shared/ui/ranked-list.tsx` (106 lines)
- `src/shared/ui/scroll-area.tsx` (39 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/search-input.tsx` (135 lines)
- `src/shared/ui/searchable-select.tsx` (227 lines)
- `src/shared/ui/select.tsx` (147 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/separator.tsx` (23 lines)
- `src/shared/ui/sheet.tsx` (77 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/skeleton.tsx` (7 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/stat-card.tsx` (106 lines)
- `src/shared/ui/switch.tsx` (26 lines)
- `src/shared/ui/tabs.tsx` (49 lines)
- `src/shared/ui/textarea.tsx` (20 lines)
- `src/shared/ui/toaster.tsx` (102 lines)
- `src/shared/ui/tooltip.tsx` (26 lines)
- `src/shared/ui/truncate.tsx` (58 lines)
- `src/shared/ui/z-index.ts` (30 lines)  — **REFERENCE: do not audit, do not edit**
- `src/vite-env.d.ts` (16 lines)
- `src/app/console-silencer.ts` (44 lines)
- `src/app/index.css` (225 lines)  — **REFERENCE: do not audit, do not edit**
- `src/app/main.tsx` (30 lines)
- `src/app/providers/index.tsx` (49 lines)
