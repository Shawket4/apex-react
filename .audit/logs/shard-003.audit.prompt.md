# UI coherence audit — shard shard-003 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-003.md` with this structure:
...
## Findings
### shard-003-F01 · <severity> · <confidence> · <dimension>
