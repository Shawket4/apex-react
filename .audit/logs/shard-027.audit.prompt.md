# UI coherence audit — shard shard-027 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-027.md` with this structure:
...
## Findings
### shard-027-F01 · <severity> · <confidence> · <dimension>
