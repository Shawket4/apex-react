# UI coherence audit — shard shard-019 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-019.md` with this structure:
...
## Findings
### shard-019-F01 · <severity> · <confidence> · <dimension>
...
## Shard files
- `src/entities/transaction/api.ts` (218 lines)
- `src/entities/transaction/categories.ts` (205 lines)
- `src/entities/transaction/defaults.ts` (35 lines)
- `src/entities/transaction/queries.ts` (310 lines)
- `src/entities/transaction/schemas.ts` (280 lines)
- `src/entities/transaction/vehicles.ts` (47 lines)
- `src/entities/trip/api.ts` (211 lines)
- `src/entities/trip/defaults.ts` (78 lines)
- `src/entities/trip/queries.ts` (179 lines)
- `src/entities/trip/schemas.ts` (444 lines)
