# UI coherence audit — shard shard-024 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-024.md` with this structure:
...
## Findings
### shard-024-F01 · <severity> · <confidence> · <dimension>
