# UI coherence fix — shard shard-023
...
3. `.audit/findings/shard-023.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-023.fix.md`, even when nothing was applied:

```
# Fix log — shard-023
| Finding | Status | Detail |
|---|---|---|
| shard-023-F01 | applied | `old-class` → `new-class` in file:line |
| shard-023-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
