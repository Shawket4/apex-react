# UI coherence fix — shard shard-006
...
3. `.audit/findings/shard-006.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-006.fix.md`, even when nothing was applied:

```
# Fix log — shard-006
| Finding | Status | Detail |
|---|---|---|
| shard-006-F01 | applied | `old-class` → `new-class` in file:line |
| shard-006-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/entities/dashboard/api.ts` (141 lines)
- `src/entities/dashboard/queries.ts` (139 lines)
- `src/entities/dashboard/schemas.ts` (231 lines)
- `src/pages/dashboard/dashboard.tsx` (1038 lines)  — **REFERENCE: do not audit, do not edit**
- `src/entities/driver/api.ts` (106 lines)
- `src/entities/driver/queries.ts` (199 lines)
- `src/entities/driver/schemas.ts` (103 lines)
- `src/entities/driver-analytics/api.ts` (18 lines)
- `src/entities/driver-analytics/queries.ts` (27 lines)
- `src/entities/driver-analytics/schemas.ts` (107 lines)
- `src/pages/driver-detail/driver-detail.tsx` (259 lines)
