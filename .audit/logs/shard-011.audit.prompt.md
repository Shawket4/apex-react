# UI coherence audit — shard shard-011 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-011.md` with this structure:
...
## Findings
### shard-011-F01 · <severity> · <confidence> · <dimension>
