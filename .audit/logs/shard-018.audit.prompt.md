# UI coherence audit — shard shard-018 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-018.md` with this structure:
...
## Findings
### shard-018-F01 · <severity> · <confidence> · <dimension>
