...
3. Append to `.audit/findings/repairs-widgets.md` a table row per item: `| R01 | applied | what changed, file:line |` or `| R01 | skipped | why |`, ending with a line exactly `APPLIED: <n> SKIPPED: <m>`.

Print that last line as your final output.

## Your files
- `src/widgets/driver-detail/financial-tab.tsx` (R12)
- `src/widgets/fleet-expenses-table/ledger-list.tsx` (R14)
- `src/widgets/fleet-expenses-table/party-picker.tsx` (R32)
- `src/widgets/fuel-events-table/fuel-events-filters.tsx` (R20)
- `src/widgets/oil-changes-table/oil-changes-filters.tsx` (R30)
- `src/widgets/service-invoice-details/service-invoice-details.tsx` (R10, R11, R16)
- `src/widgets/trip-audit-detail-dialog/trip-audit-detail-dialog.tsx` (R15)
- `src/widgets/trips-statistics/trips-statistics-companies.tsx` (R33, R35)
- `src/widgets/trips-statistics/trips-statistics-routes.tsx` (R34)
- `src/widgets/trips-table/trips-filters.tsx` (R36)
