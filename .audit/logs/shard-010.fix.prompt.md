# UI coherence fix — shard shard-010
...
3. `.audit/findings/shard-010.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-010.fix.md`, even when nothing was applied:

```
# Fix log — shard-010
| Finding | Status | Detail |
|---|---|---|
| shard-010-F01 | applied | `old-class` → `new-class` in file:line |
| shard-010-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/pages/fleet-expenses/fleet-expense-edit.tsx` (5 lines)
- `src/pages/fleet-expenses/fleet-expense-form.tsx` (726 lines)
- `src/pages/fleet-expenses/fleet-expense-new.tsx` (5 lines)
- `src/pages/fleet-expenses/fleet-expenses-messages.tsx` (275 lines)
- `src/pages/fleet-expenses/fleet-expenses.tsx` (775 lines)
