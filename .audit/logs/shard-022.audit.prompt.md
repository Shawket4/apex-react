# UI coherence audit — shard shard-022 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-022.md` with this structure:
...
## Findings
### shard-022-F01 · <severity> · <confidence> · <dimension>
