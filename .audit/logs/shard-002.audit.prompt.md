# UI coherence audit — shard shard-002 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-002.md` with this structure:
...
## Findings
### shard-002-F01 · <severity> · <confidence> · <dimension>
