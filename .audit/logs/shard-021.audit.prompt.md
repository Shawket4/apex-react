# UI coherence audit — shard shard-021 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-021.md` with this structure:
...
## Findings
### shard-021-F01 · <severity> · <confidence> · <dimension>
