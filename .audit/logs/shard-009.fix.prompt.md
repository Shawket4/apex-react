# UI coherence fix — shard shard-009
...
3. `.audit/findings/shard-009.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-009.fix.md`, even when nothing was applied:

```
# Fix log — shard-009
| Finding | Status | Detail |
|---|---|---|
| shard-009-F01 | applied | `old-class` → `new-class` in file:line |
| shard-009-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
