# UI coherence audit — shard shard-014 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-014.md` with this structure:
...
## Findings
### shard-014-F01 · <severity> · <confidence> · <dimension>
