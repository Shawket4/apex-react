# UI coherence audit — shard shard-025 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-025.md` with this structure:
...
## Findings
### shard-025-F01 · <severity> · <confidence> · <dimension>
