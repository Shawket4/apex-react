# UI coherence fix — shard shard-024
...
3. `.audit/findings/shard-024.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-024.fix.md`, even when nothing was applied:

```
# Fix log — shard-024
| Finding | Status | Detail |
|---|---|---|
| shard-024-F01 | applied | `old-class` → `new-class` in file:line |
| shard-024-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/pages/trip-replay/playback-core.ts` (268 lines)
- `src/pages/trip-replay/replay-engine.ts` (369 lines)
- `src/pages/trip-replay/replay-model.ts` (646 lines)
- `src/pages/trip-replay/trip-replay.tsx` (642 lines)
- `src/pages/trip-replay/use-trip-playback-history.ts` (159 lines)
- `src/widgets/trip-replay-hud/index.ts` (2 lines)
- `src/widgets/trip-replay-hud/trip-replay-hud.tsx` (297 lines)
