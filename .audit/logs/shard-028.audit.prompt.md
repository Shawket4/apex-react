# UI coherence audit — shard shard-028 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-028.md` with this structure:
...
## Findings
### shard-028-F01 · <severity> · <confidence> · <dimension>
