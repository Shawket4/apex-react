# UI coherence fix — shard shard-013
...
3. `.audit/findings/shard-013.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-013.fix.md`, even when nothing was applied:

```
# Fix log — shard-013
| Finding | Status | Detail |
|---|---|---|
| shard-013-F01 | applied | `old-class` → `new-class` in file:line |
| shard-013-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/entities/location/api.ts` (174 lines)
- `src/entities/location/index.ts` (3 lines)
- `src/entities/location/queries.ts` (319 lines)
- `src/entities/location/schemas.ts` (214 lines)
- `src/pages/locations/locations.tsx` (389 lines)
- `src/widgets/locations-dropoff-dialog/index.ts` (1 lines)
- `src/widgets/locations-dropoff-dialog/locations-dropoff-dialog.tsx` (243 lines)
- `src/widgets/locations-dropoffs-table/columns.tsx` (105 lines)
- `src/widgets/locations-dropoffs-table/index.ts` (2 lines)
- `src/widgets/locations-dropoffs-table/locations-dropoffs-table.tsx` (40 lines)
- `src/widgets/locations-dropoffs-table/pin-source-badge.tsx` (28 lines)
- `src/widgets/locations-map-picker/index.ts` (1 lines)
- `src/widgets/locations-map-picker/locations-map-picker.tsx` (126 lines)
- `src/widgets/locations-needs-attention/index.ts` (1 lines)
- `src/widgets/locations-needs-attention/locations-needs-attention.tsx` (700 lines)
