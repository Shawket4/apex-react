# UI coherence audit — shard shard-007 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-007.md` with this structure:
...
## Findings
### shard-007-F01 · <severity> · <confidence> · <dimension>
