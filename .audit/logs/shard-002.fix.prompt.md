# UI coherence fix — shard shard-002
...
3. `.audit/findings/shard-002.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-002.fix.md`, even when nothing was applied:

```
# Fix log — shard-002
| Finding | Status | Detail |
|---|---|---|
| shard-002-F01 | applied | `old-class` → `new-class` in file:line |
| shard-002-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/shared/lib/maps/google-provider.tsx` (777 lines)
- `src/shared/lib/maps/leaflet-provider.tsx` (529 lines)
- `src/shared/lib/maps/map-pool.ts` (121 lines)
- `src/shared/lib/maps/marker-svg.ts` (248 lines)
- `src/shared/lib/maps/types.ts` (143 lines)
- `src/shared/lib/prefetch/assets.ts` (28 lines)
- `src/shared/lib/prefetch/chunks.ts` (147 lines)
- `src/shared/lib/prefetch/forms.ts` (63 lines)
- `src/shared/lib/prefetch/index.ts` (19 lines)
- `src/shared/lib/prefetch/intent.ts` (24 lines)
- `src/shared/lib/prefetch/routes.ts` (81 lines)
- `src/shared/scope/index.ts` (2 lines)
- `src/shared/scope/scope.ts` (222 lines)
- `src/shared/scope/use-scope.ts` (95 lines)
