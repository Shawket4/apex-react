# UI coherence audit — shard shard-004 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-004.md` with this structure:
...
## Findings
### shard-004-F01 · <severity> · <confidence> · <dimension>
