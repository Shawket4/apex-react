# UI coherence fix — shard shard-018
...
3. `.audit/findings/shard-018.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-018.fix.md`, even when nothing was applied:

```
# Fix log — shard-018
| Finding | Status | Detail |
|---|---|---|
| shard-018-F01 | applied | `old-class` → `new-class` in file:line |
| shard-018-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/features/tracking/components/fleet-panel.tsx` (188 lines)
- `src/features/tracking/components/range-picker.tsx` (254 lines)
- `src/features/tracking/components/replay-transport.tsx` (254 lines)
- `src/features/tracking/components/status-chips.tsx` (77 lines)
- `src/features/tracking/components/time-deck.tsx` (662 lines)
- `src/features/tracking/components/vehicle-card.tsx` (95 lines)
- `src/features/tracking/map/layers.ts` (373 lines)
- `src/features/tracking/map/tracking-map.tsx` (554 lines)
