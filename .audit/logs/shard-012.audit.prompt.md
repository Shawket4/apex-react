# UI coherence audit — shard shard-012 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-012.md` with this structure:
...
## Findings
### shard-012-F01 · <severity> · <confidence> · <dimension>
