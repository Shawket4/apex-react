# UI coherence fix — shard shard-003
...
3. `.audit/findings/shard-003.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-003.fix.md`, even when nothing was applied:

```
# Fix log — shard-003
| Finding | Status | Detail |
|---|---|---|
| shard-003-F01 | applied | `old-class` → `new-class` in file:line |
| shard-003-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
- `src/shared/ui/avatar.tsx` (44 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/badge.tsx` (30 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/button.tsx` (52 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/cairo-range-calendar.tsx` (167 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/card.tsx` (54 lines)
- `src/shared/ui/chart-card.tsx` (82 lines)
- `src/shared/ui/checkbox.tsx` (25 lines)
- `src/shared/ui/collapsible-section.tsx` (107 lines)
- `src/shared/ui/command.tsx` (147 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/confirm-dialog.tsx` (106 lines)
- `src/shared/ui/data-table.tsx` (311 lines)
- `src/shared/ui/date-picker.tsx` (194 lines)
- `src/shared/ui/date-range-picker.tsx` (287 lines)
- `src/shared/ui/dialog.tsx` (115 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/draggable.tsx` (199 lines)
- `src/shared/ui/dropdown-menu.tsx` (170 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/empty-state.tsx` (59 lines)  — **REFERENCE: do not audit, do not edit**
- `src/shared/ui/form.tsx` (170 lines)
- `src/shared/ui/input.tsx` (28 lines)
- `src/shared/ui/label.tsx` (18 lines)
