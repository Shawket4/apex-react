# UI coherence audit — shard shard-015 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-015.md` with this structure:
...
## Findings
### shard-015-F01 · <severity> · <confidence> · <dimension>
