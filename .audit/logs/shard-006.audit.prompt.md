# UI coherence audit — shard shard-006 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-006.md` with this structure:
...
## Findings
### shard-006-F01 · <severity> · <confidence> · <dimension>
