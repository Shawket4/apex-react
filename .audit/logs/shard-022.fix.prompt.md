# UI coherence fix — shard shard-022
...
3. `.audit/findings/shard-022.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-022.fix.md`, even when nothing was applied:

```
# Fix log — shard-022
| Finding | Status | Detail |
|---|---|---|
| shard-022-F01 | applied | `old-class` → `new-class` in file:line |
| shard-022-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/widgets/trip-form/drop-off-picker-modal.tsx` (276 lines)
- `src/widgets/trip-form/duplicate-comparison-dialog.tsx` (276 lines)
- `src/widgets/trip-form/trip-form.tsx` (1331 lines)
- `src/widgets/trip-location-dialog/trip-location-dialog.tsx` (466 lines)
