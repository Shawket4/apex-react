# UI coherence fix — shard shard-025
...
3. `.audit/findings/shard-025.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-025.fix.md`, even when nothing was applied:

```
# Fix log — shard-025
| Finding | Status | Detail |
|---|---|---|
| shard-025-F01 | applied | `old-class` → `new-class` in file:line |
| shard-025-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/widgets/trip-replay-leg-rail/index.ts` (2 lines)
- `src/widgets/trip-replay-leg-rail/trip-replay-leg-rail.tsx` (189 lines)
- `src/widgets/trip-replay-map/google-adapter.ts` (268 lines)
- `src/widgets/trip-replay-map/index.ts` (9 lines)
- `src/widgets/trip-replay-map/leaflet-adapter.ts` (227 lines)
- `src/widgets/trip-replay-map/trip-replay-map.tsx` (137 lines)
- `src/widgets/trip-replay-map/types.ts` (62 lines)
- `src/widgets/trip-replay-timeline/index.ts` (6 lines)
- `src/widgets/trip-replay-timeline/trip-replay-timeline.tsx` (381 lines)
- `src/entities/trip-statistics/api.ts` (60 lines)
- `src/entities/trip-statistics/queries.ts` (79 lines)
- `src/entities/trip-statistics/schemas.ts` (280 lines)
- `src/entities/trip-summary/api.ts` (83 lines)
- `src/entities/trip-summary/queries.ts` (22 lines)
- `src/entities/trip-summary/schemas.ts` (143 lines)
