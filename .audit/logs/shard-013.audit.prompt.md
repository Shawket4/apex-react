# UI coherence audit — shard shard-013 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-013.md` with this structure:
...
## Findings
### shard-013-F01 · <severity> · <confidence> · <dimension>
