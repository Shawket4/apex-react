# UI coherence fix — shard shard-028
...
3. `.audit/findings/shard-028.md` — the findings for this shard.
...
3. **Always** write `.audit/findings/shard-028.fix.md`, even when nothing was applied:

```
# Fix log — shard-028
| Finding | Status | Detail |
|---|---|---|
| shard-028-F01 | applied | `old-class` → `new-class` in file:line |
| shard-028-F02 | skipped | reason (needs-ruling / out-of-shard: … / reference file / would delete handler / low confidence / …) |
…
...
## Shard files
- `src/widgets/trips-table/receipt-status-badge.tsx` (59 lines)
- `src/widgets/trips-table/revenue-breakdown.tsx` (229 lines)
- `src/widgets/trips-table/trip-row.ts` (113 lines)
- `src/widgets/trips-table/trips-desktop-table.tsx` (627 lines)
- `src/widgets/trips-table/trips-filters.tsx` (256 lines)
- `src/widgets/trips-table/trips-mobile-list.tsx` (391 lines)
- `src/widgets/trips-table/trips-pagination.tsx` (253 lines)
- `src/widgets/trips-table/trips-table.tsx` (82 lines)
- `src/entities/user/api.ts` (33 lines)
- `src/entities/user/queries.ts` (69 lines)
- `src/entities/user/schemas.ts` (42 lines)
- `src/widgets/user-form-dialog/user-form-dialog.tsx` (230 lines)
- `src/widgets/user-menu/user-menu.tsx` (99 lines)  — **REFERENCE: do not audit, do not edit**
