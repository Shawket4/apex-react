# UI coherence audit — shard shard-001 (READ-ONLY)
...
## Output
Write exactly one file: `.audit/findings/shard-001.md` with this structure:
...
## Findings
### shard-001-F01 · <severity> · <confidence> · <dimension>
