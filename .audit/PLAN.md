...
- **Current phase:** Reference remediation (owner-approved rulings) applied 2026-08-29; design system extracted to `.audit/design-system.md`. Next: re-baseline screenshots, then Phase 3 (aesthetic brief) → shard audit → remediation of the other shards.
